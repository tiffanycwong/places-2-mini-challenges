...
class Model(AbstractModel):
    def build_model(self):
        ...
        outputs = [scene_logits, word_embedding_logits]
    ...
    def get_losses(self):
        ...
        losses = [scene_loss, word_embedding_loss]
        return losses
    ...
    def get_eval_metric_names(self):
        return ["Scene Loss", "Scene Accuracy Top 1", "Scene Accuracy Top 5", "Word embedding loss"]

    def get_output_names(self):
        return ["Scene Classification", "Word Embedding Prediction"]
    ...
    @staticmethod
    def model_name():
        return "ShallowModel - ObjEmbeddings"
